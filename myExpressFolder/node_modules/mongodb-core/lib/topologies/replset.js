...
ReplSet.prototype.command = function(ns, cmd, options, callback) {
  ...
  if(!this.isConnected(options) && this.s.disconnectHandler != null) {
    ...
    return this.s.disconnectHandler.addManual('command', ns, cmd, options, callback);
  }
...
ReplSet.prototype.remove = function(ns, ops, options, callback) {
  ...
  if(!this.isConnected() && this.s.disconnectHandler != null) {
    callback = bindToCurrentDomain(callback);
    return this.s.disconnectHandler.addManual('remove', ns, ops, options, callback);
  }
...
ReplSet.prototype.insert = function(ns, ops, options, callback) {
  ...
  if(!this.isConnected() && this.s.disconnectHandler != null) {
    callback = bindToCurrentDomain(callback);
    return this.s.disconnectHandler.addManual('insert', ns, ops, options, callback);
  }
...
ReplSet.prototype.update = function(ns, ops, options, callback) {
  ...
  if(!this.isConnected() && this.s.disconnectHandler != null) {
    callback = bindToCurrentDomain(callback);
    return this.s.disconnectHandler.addManual('update', ns, ops, options, callback);
  }
