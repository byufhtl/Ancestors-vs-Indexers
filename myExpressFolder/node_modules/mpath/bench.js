...
var sha = require('child_process').exec("git log --pretty=format:'%h' -n 1", function (err, sha) {
  ...
  s.addManual('mpath.get("first", obj)', function () {
    mpath.get('first', o);
  })
  s.addManual('mpath.get("first.second", obj)', function () {
    mpath.get('first.second', o);
  })
  s.addManual('mpath.get("first.second.third.1.name", obj)', function () {
    mpath.get('first.second.third.1.name', o);
  })
  s.addManual('mpath.get("comments", obj)', function () {
    mpath.get('comments', o);
  })
  s.addManual('mpath.get("comments.1", obj)', function () {
    mpath.get('comments.1', o);
  })
  s.addManual('mpath.get("comments.2.name", obj)', function () {
    mpath.get('comments.2.name', o);
  })
  s.addManual('mpath.get("comments.2.comments.1.comments.0.val", obj)', function () {
    mpath.get('comments.2.comments.1.comments.0.val', o);
  })
  s.addManual('mpath.get("comments.name", obj)', function () {
    mpath.get('comments.name', o);
  })

  s.addManual('mpath.set("first", obj, val)', function () {
    mpath.set('first', o, 1);
  })
  s.addManual('mpath.set("first.second", obj, val)', function () {
    mpath.set('first.second', o, 1);
  })
  s.addManual('mpath.set("first.second.third.1.name", obj, val)', function () {
    mpath.set('first.second.third.1.name', o, 1);
  })
  s.addManual('mpath.set("comments", obj, val)', function () {
    mpath.set('comments', o, 1);
  })
  s.addManual('mpath.set("comments.1", obj, val)', function () {
    mpath.set('comments.1', o, 1);
  })
  s.addManual('mpath.set("comments.2.name", obj, val)', function () {
    mpath.set('comments.2.name', o, 1);
  })
  s.addManual('mpath.set("comments.2.comments.1.comments.0.val", obj, val)', function () {
    mpath.set('comments.2.comments.1.comments.0.val', o, 1);
  })
  s.addManual('mpath.set("comments.name", obj, val)', function () {
