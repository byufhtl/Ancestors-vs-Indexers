 ...
 * @api private
 */
function subPopulate(docs, options, cache, callback) {
  var _this = this;
...
function populate(model, docs, options, callback) {
  ...
  for (i = 0; i < len; i++) {
    ...
    if (mod.justOne) {
      mod.Model.findOne(match, select, mod.options.options,
        next.bind(this, mod, assignmentOpts));
    } else {
      mod.Model.find(match, select, mod.options.options,
        next.bind(this, mod, assignmentOpts));
    }
  }
    ...
    if (refPath) {
      ...
      if (!modelNameFromQuery) {
        ...
        modelNames = [
          ...
          || virtual && virtual.options && virtual.options.ref
