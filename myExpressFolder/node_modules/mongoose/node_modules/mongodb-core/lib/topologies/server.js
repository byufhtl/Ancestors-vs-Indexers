...
Server.prototype.command = function(ns, cmd, options, callback) {
  ...
  if(!self.isConnected() && self.s.disconnectHandler != null) {
    ...
    return self.s.disconnectHandler.addManual('command', ns, cmd, options, callback);
  }
...
Server.prototype.insert = function(ns, ops, options, callback) {
  ...
  if(!self.isConnected() && self.s.disconnectHandler != null) {
    callback = bindToCurrentDomain(callback);
    return self.s.disconnectHandler.addManual('insert', ns, ops, options, callback);
  }
...
Server.prototype.update = function(ns, ops, options, callback) {
  ...
  if(!self.isConnected() && self.s.disconnectHandler != null) {
    callback = bindToCurrentDomain(callback);
    return self.s.disconnectHandler.addManual('update', ns, ops, options, callback);
  }
...
Server.prototype.remove = function(ns, ops, options, callback) {
  ...
  if(!self.isConnected() && self.s.disconnectHandler != null) {
    callback = bindToCurrentDomain(callback);
    return self.s.disconnectHandler.addManual('remove', ns, ops, options, callback);
  }
