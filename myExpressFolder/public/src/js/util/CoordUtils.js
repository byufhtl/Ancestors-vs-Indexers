...
define([],function(){
     ...
     * @param dx The maximum distance between x values to qualify
     * @param dy The maximum distance between y values to qualify (Set to dx by default for radial checking.
     * @returns {boolean}
     */
